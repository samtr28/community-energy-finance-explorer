...
class Project_Card(Project_CardTemplate):
  def __init__(self, **properties):
    ...
    if is_portfolio:
      ...
      # If you have a sub_projects_panel (repeating panel), populate it
  ...
  def project_card_click(self, **event_args):
    """Handle card selection — uses record_id instead of index"""
    ...
    # Toggle selection
    if form._selected_record_id == record_id:
      form._unselect_all()
    else:
